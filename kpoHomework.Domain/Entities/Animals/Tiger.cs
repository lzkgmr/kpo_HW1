...
/// <summary>
/// Tiger class that implementing Predator abstract class.
/// </summary>
...
public class Tiger(string name, int food, bool isHealthy, int kindness) : Predator(name, food, isHealthy, kindness)
{
}